                ...
                <Row className={styles.cardMainRow} style={{ margin: '0', display: "flex" }}  >
...

                    {
                        countries.map((peep, i) =>
                            <Col
                                onClick={() => {
                                    router.push(`/countries/${peep.name.official}`)
                                }}
                                className={styles.row}
                                lg={3} md={4} xs={6} key={i} style={{ margin: "0.5rem 0", padding: "0.5rem", borderRadius: "1rem", }}   >
                                <Link scroll={false} href={`/countries/${peep.name.official}`} style={{ textDecoration: "none", color: 'inherit', height: "100%", width: "100%" }} >
                                    <div className={darkMode ? styles.linkCard_dm : styles.linkCard} style={{ height: "100%", width: "100%" }}  >
                                        ...
                                        <div style={{ padding: "0.5rem" }} >
                                            ...
                                            <div style={{ display: "flex" }} >
                                                <p style={{ textAlign: "center", width: "100%", fontSize: "14px", marginBottom: "0.5rem" }} ><b>{peep.name.official}</b></p>
                                                {/* <h6>Entrepreneur</h6> */}
                                            </div>
