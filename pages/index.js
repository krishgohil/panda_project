  ...
  return (
    <>
      ...
      <Container onClick={() => {
        ...
        <Row className={styles.cardMainRow} style={{ margin: 0 }}  >
...

            {
              tempArr.map((peep, i) =>
                <Col
                  ...
                  className={darkMode ? styles.linkCard_dm : styles.linkCard} lg={3} md={3} xs={5} key={i} style={{ margin: "1rem 0.5rem", padding: "0", borderRadius: "1rem", }}   >
                  <div className={styles.contain}>
                    <div className={styles.imgupdiv} style={{ display: "flex", justifyContent: "center", }} >
