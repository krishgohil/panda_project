...
const Restaurants = () => {
  ...
  async function fetchitems() {
    ...
    const response = await fetch(`${host}/api/post/fetchitems`, {
      ...
      body: JSON.stringify({ skip: 0,category:"restaurants" }),
    });
            ...
            return (
              <>
                <Col
                  ...
                  <Link scroll={false} href={`/restaurants/${show._id}`} style={{ textDecoration: "none", color: 'inherit', height: "100%", width: "100%" }} >
