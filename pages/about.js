...
const About = () => {
    ...
    return (
        <>
            <dialog open style={{ position: 'absolute', border: 'none', color: 'white', zIndex: 999, left: '0%', backgroundColor: "rgba(0,0,0,.85)", height: '100vh', width: '100vw', position: 'fixed',  overflowY: 'scroll', scrollMargin: 0,  top: '0vh',  padding: 0}}>
